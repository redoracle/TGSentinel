...
class TestLoadConfig:
    ...
    def test_load_config_alert_env_overrides(
        ...
        monkeypatch.setenv("ALERT_MODE", "channel")
        monkeypatch.setenv("ALERT_CHANNEL", "@kit_red_bot")
        ...
        assert cfg.alerts.target_channel == "@kit_red_bot"
    ...
    def test_load_config_redis_defaults(
        ...
        assert cfg.redis["stream"] == "tgsentinel:messages"
        assert cfg.redis["group"] == "workers"
        assert cfg.redis["consumer"] == "worker-1"
    ...
    def test_load_config_custom_redis(
        ...
        assert cfg.redis["stream"] == "custom:stream"
...
class TestChannelRule:
    ...
    def test_channel_rule_defaults(self):
        ...
        rule = ChannelRule(id=-100123456789)

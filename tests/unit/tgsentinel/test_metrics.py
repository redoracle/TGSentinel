...
class TestMetricsInc:
    ...
    def test_inc_messages_ingested(self):
        ...
        inc("messages_ingested", chat_id=123, chat_name="test")
    ...
    def test_inc_alerts_generated(self):
        ...
        inc("alerts_generated", channel="dm", trigger_type="keyword")
    ...
    def test_inc_feedback_submitted(self):
        ...
        inc("feedback_submitted", label=1)
    ...
    def test_inc_different_labels_different_series(self):
        ...
        inc("messages_processed", status="success")
        inc("messages_processed", status="error")
...
class TestMetricsDump:
    ...
    def test_dump_format_prometheus_style(self, caplog):
        ...
        # With new Prometheus metrics, dump is a no-op that logs a debug message
        assert "Metrics dump called" in log_text or "auto-exported" in log_text

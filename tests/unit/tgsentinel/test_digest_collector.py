...
def test_engine():
    ...
    # Create messages table with Phase 1 schema
...
def sample_messages(test_engine):
    ...
    with test_engine.begin() as con:
        ...
        con.execute(
            text(
                """
            INSERT INTO messages (chat_id, msg_id, content_hash, score, alerted, chat_title, sender_name, message_text, trigger_annotations, created_at, matched_profiles, digest_schedule, digest_processed)
            VALUES (-1001111111111, 1, 'hash1', 8.5, 1, 'Security Channel', 'Bot', 'CVE-2024-1234 critical', '{"security": ["CVE"]}', :ts1, '["security"]', 'hourly', 0)
        """
            ),
        ...
        con.execute(
            text(
                """
            INSERT INTO messages (chat_id, msg_id, content_hash, score, alerted, chat_title, sender_name, message_text, trigger_annotations, created_at, matched_profiles, digest_schedule, digest_processed)
            VALUES (-1001111111111, 2, 'hash2', 7.0, 1, 'Security Channel', 'Admin', 'Vulnerability found', '{"security": ["vulnerability"]}', :ts2, '["security", "critical"]', 'hourly', 0)
        """
            ),
        ...
        con.execute(
            text(
                """
            INSERT INTO messages (chat_id, msg_id, content_hash, score, alerted, chat_title, sender_name, message_text, trigger_annotations, created_at, matched_profiles, digest_schedule, digest_processed)
            VALUES (-1001222222222, 1, 'hash3', 6.5, 1, 'News Channel', 'NewsBot', 'Daily update', '{}', :ts3, '["news"]', 'daily', 0)
        """
            ),
        ...
        con.execute(
            text(
                """
            INSERT INTO messages (chat_id, msg_id, content_hash, score, alerted, chat_title, sender_name, message_text, trigger_annotations, created_at, matched_profiles, digest_schedule, digest_processed)
            VALUES (-1001111111111, 3, 'hash4', 9.0, 1, 'Security Channel', 'Bot', 'Already sent', '{}', :ts4, '["security"]', 'hourly', 1)
        """
            ),
        ...
        con.execute(
            text(
                """
            INSERT INTO messages (chat_id, msg_id, content_hash, score, alerted, chat_title, sender_name, message_text, trigger_annotations, created_at, matched_profiles, digest_schedule, digest_processed)
            VALUES (-1001333333333, 1, 'hash5', 5.0, 0, 'Test Channel', 'User', 'Not alerted', '{}', :ts5, '["test"]', 'hourly', 0)
        """
            ),
        ...
        with test_engine.begin() as con:
            con.execute(
                ...
                INSERT INTO messages (
                    chat_id, msg_id, content_hash, score, alerted,
                    chat_title, sender_name, message_text, trigger_annotations,
                    created_at, matched_profiles, digest_schedule, digest_processed
                ) VALUES (:chat_id, :msg_id, :content_hash, :score, :alerted, :chat_title, :sender_name, :message_text, :trigger_annotations, :created_at, :matched_profiles, :digest_schedule, :digest_processed)
                """
                ),
                {

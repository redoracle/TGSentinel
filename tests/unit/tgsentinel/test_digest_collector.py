    ...
    with test_engine.begin() as con:
        ...
        con.execute(
            ...
            VALUES (
                ...
                'CVE-2024-1234 critical', '{"security": ["CVE"]}', :ts1, '["security"]',
                'hourly', 0
            )
        """
            ),
        ...
        con.execute(
            ...
            VALUES (
                ...
                'Vulnerability found', '{"security": ["vulnerability"]}', :ts2,
        ...
        con.execute(
            ...
            VALUES (
                ...
                'Already sent', '{}', :ts4, '["security"]', 'hourly', 1
            )
        """
            ),
    ...
    def test_collect_respects_time_window(self, test_engine):
        ...
        with test_engine.begin() as con:
            con.execute(
                ...
                :flagged_for_interest_feed, :feed_interest_flag, :chat_title, :sender_name, :message_text, \

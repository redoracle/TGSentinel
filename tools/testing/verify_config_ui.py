    ...
    try:
        ...
        with urlopen(req, timeout=5) as response:
            ...
            checks = [
                ...
                (
                    "NOTIFICATION_MODE populated",
                    alerts.get("mode") == os.getenv("NOTIFICATION_MODE"),
                ),
                (
                    "NOTIFICATION_CHANNEL populated",
                    alerts.get("target_channel") == os.getenv("NOTIFICATION_CHANNEL"),
                ),

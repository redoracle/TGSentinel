...
Examples:
  ...
  Provide API credentials:
    ...
    if success:
        ...
        print("Next Steps:")
        print(f"{'='*60}")
        print(f"1. Open TG Sentinel UI in your browser")
        print(f"2. Click 'Authenticate Telegram Session'")
        print(f"3. Select 'Upload Session' tab")
        print(f"4. Upload the file: {output_path}")
        print(f"5. Click 'Upload & Restore'")

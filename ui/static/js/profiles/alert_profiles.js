...
(function() {
    ...
    async function loadAlertProfile(profileId) {
        try {
            ...
            if (window.AlertFeedbackStats && window.AlertFeedbackStats.loadStatsForProfile) {
                window.AlertFeedbackStats.loadStatsForProfile(profileId);
            }
    ...
    async function saveAlertProfile(event) {
        ...
        for (let i = 1; i <= 3; i++) {
            ...
            const schedule = {
                schedule: type || "none",  // Use "none" for empty type

...
/**
 * Initialize global modal hide handlers to prevent aria-hidden focus issues.
 * This should be called once on page load.
 */
function initModalAccessibilityFixes() {
    // Listen for all modal hide events and blur focused elements
...
window.SharedUtils = {
    ...
    applyGlassBackdrop,
    safeHideModal,
    initModalAccessibilityFixes
};

// Initialize modal accessibility fixes on load
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', initModalAccessibilityFixes);
} else {
    initModalAccessibilityFixes();
}

...
async def notify_dm(
    ...
    message = render_dm_alert(
        ...
        # Pass all available optional variables
        sender_id=None,  # Not provided by callers yet
        keyword_score=None,  # Not separated from combined score
        semantic_score=None,  # Not separated from combined score
        profile_id=None,  # Not provided by callers
        timestamp=None,  # Not provided by callers
        message_link=None,  # Not available for DM alerts
        chat_id=None,  # Not provided by callers
        msg_id=None,  # Not provided by callers
        reactions=None,  # Not available for DM alerts
        is_vip=None,  # TODO: Could be determined from VIP list
    )
...
async def save_to_telegram(
    ...
    message = render_saved_message(
        ...
        chat_id=None,  # Not provided by callers
        msg_id=None,  # Not provided by callers
        reactions=None,  # Not tracked currently
        is_vip=None,  # TODO: Could be determined from VIP list
    )

...
def create_api_app() -> Flask:
    ...
    def validate_digest_config(data: dict) -> tuple[bool, str]:
        ...
        # 3. Valid mode (dm, digest, both - 'channel' deprecated)
        ...
        # 6. target_channel required if mode=digest or both
    ...
    def preview_message_format():
        ...
        try:
            ...
            if "." in format_type:
                ...
                sample_key = f"{main_type}_{subtype}"
            else:
                template = custom_template or get_format(format_type)
                sample_key = format_type
    ...
    def test_message_format():
        ...
        try:
            ...
            # Get sample data
            sample = SAMPLE_DATA.get(sample_key, {})

...
.PHONY: upgrade
upgrade: ## Secure dependency upgrade using pip-tools (creates requirements.in, compiles, installs)
	@printf "$(CYAN)🔒 Performing secure dependency upgrade with pip-tools...$(RESET)\n"
	$(call ensure_venv)
